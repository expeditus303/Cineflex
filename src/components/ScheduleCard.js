            ...
            <ScheduleCardContainer>
                ...
                <div>
                    {days.showtimes.map((s) => (
                        <ScheduleCardTime key={s.id} id={s.id} showtimes={s} weekday={days.weekday} date={days.date} setSelectedShowTime={setSelectedShowTime} setSelectedSeat={setSelectedSeat}/>
                    ))}
                </div>
            </ScheduleCardContainer>
